var ExampleApplication = React.createClass({
    render: function() {
        var qryParam1 = this.props.queryString.param1;
        var qryParam2 = this.props.queryString.param2;
        
        var message =
          'React has been successfully running for ' + qryParam1 + ' Param1.- ' + qryParam2 + ' Param2.';
...
ReactDOM.render(
  <ExampleApplication queryString={ queryString } />,
  react
);
