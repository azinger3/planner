                  ...
                  <table class="table table-striped table-hover small">
                     ...
                     <tbody>
                        ...
                        <tr class="uxEdit editing" data-transaction-id="3">
                           ...
                           <td>
                              <input type="text" class="form-control input-sm input-amount-edit uxAmountEdit" value="8888.00" />
                           </td>
                           <td>
                              <a href="javascript:void(0);" class="uxSave btn btn-info btn-xs"><i class="fa fa-floppy-o" aria-hidden="true"></i></a>
                           </td>
                        </tr>
